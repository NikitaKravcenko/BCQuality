...
id: taylor-docs
version: 1
title: Taylor Docs - Documentation & Knowledge Management (Wrapper)
description: Domain-focused wrapper for documentation quality and knowledge capture. Goal keywords: documentation, docs, runbook, handbook, knowledge.
...
# Taylor Docs - Documentation & Knowledge Management - Wrapper
...
Use specialist guidance from custom/skills/taylor-docs.md to shape prioritization and recommendations.

## Relevance
Apply READ frontmatter matching semantics against task context.
Prioritize this wrapper when the goal matches: documentation, docs, runbook, handbook, knowledge.
If goal and changed artifacts do not match this specialist focus (documentation quality and knowledge capture), return outcome not-applicable.
