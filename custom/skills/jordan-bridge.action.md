...
id: jordan-bridge
version: 1
title: Jordan Bridge - Integration & Extensibility Architect (Wrapper)
description: Domain-focused wrapper for integration boundaries and event-driven patterns. Goal keywords: integration, events, messaging, api contracts, boundaries.
...
# Jordan Bridge - Integration & Extensibility Architect - Wrapper
...
Use specialist guidance from custom/skills/jordan-bridge.md to shape prioritization and recommendations.

## Relevance
Apply READ frontmatter matching semantics against task context.
Prioritize this wrapper when the goal matches: integration, events, messaging, api contracts, boundaries.
If goal and changed artifacts do not match this specialist focus (integration boundaries and event-driven patterns), return outcome not-applicable.
